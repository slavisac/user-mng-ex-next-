import { Box, Button, Card, CardActions, CardContent, CardHeader, FormControl, Grid, InputLabel, MenuItem, Select, TextField, Typography } from "@mui/material";
...
const User = ({ user }) => {
    ...
    return (
        <>
            ...
            <Typography variant="h3" color='primary.main' margin={2}>User</Typography>
            <UserForm user={user} />
        </>
    )
}
